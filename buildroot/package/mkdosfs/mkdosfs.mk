...
MKDOSFS_SOURCE:=dosfstools_$(MKDOSFS_VERSION).tar.gz
#MKDOSFS_SITE:=http://ftp.uni-erlangen.de/pub/Linux/LOCAL/dosfstools
MKDOSFS_SITE:=https://stage.maemo.org/svn/maemo/projects/haf/tags/dosfstools/2.11-0osso9/
...
$(MKDOSFS_DIR)/.unpacked: $(DL_DIR)/$(MKDOSFS_SOURCE)
	...
	toolchain/patch-kernel.sh $(MKDOSFS_DIR) package/mkdosfs/ \*.diff
	toolchain/patch-kernel.sh $(MKDOSFS_DIR) package/mkdosfs/ \*.patch
...
$(TARGET_DIR)/$(MKDOSFS_TARGET_BINARY): $(MKDOSFS_DIR)/$(MKDOSFS_BINARY)
	...
	cp -a $(MKDOSFS_DIR)/dosfsck/dosfsck   $(TARGET_DIR)/sbin/dosfsck
